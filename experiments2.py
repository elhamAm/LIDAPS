...
def generate_experiment_cfgs(id, machine_name):
    ...
    gt_dir_instance = 'PATH_TO_FILL/edaps/data/cityscapes/gtFine/val'
    gt_dir_panoptic = 'PATH_TO_FILL/edaps/edata/cityscapes/gtFine_panoptic'
    ...
    # -------------------------------------------------------------------------
        ...
        checkpoint_path = 'pretrained_edaps/pretrained_edaps_weights'#'path/to/the/latest/checkpoint'
        cfg = config_from_vars()
        cfg['checkpoint_path'] = checkpoint_path
        cfgs.append(cfg)
