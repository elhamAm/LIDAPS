...
_base_ = [
		...
		"../_base_/models/maskrcnn_sepaspp_mitb5_diff.py",
		"../_base_/datasets/uda_synthia_to_cityscapes_maskrcnn_panoptic_diff.py",
...
data = dict(
        ...
        val=dict(
                ...
                data_root="PATH_TO_FILL/edaps/data/cityscapes"
        )
)
...
evaluation = dict(
    ...
    gt_dir="PATH_TO_FILL/edaps/data/cityscapes/gtFine/val",
    gt_dir_panop="PATH_TO_FILL/edaps/data/cityscapes/gtFine_panoptic",
