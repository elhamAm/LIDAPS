...
model = dict(
    type='MaskRCNNPanopticDiffUnfrozenSimpleFPN',
    pretrained='pretrained/mit_b5.pth',
    backbone=dict(type='mit_b5', style='pytorch'),
    use_neck_feat_for_decode_head=False,
    decode_head=dict(
        type='DAFormerHead',
        in_channels=[320, 660, 1300, 1280],#[64, 128, 320, 512], #[64, 128, 320, 512],#[320, 790, 1430, 1280]
        in_index=[0, 1, 2, 3],
        channels=256,
        dropout_ratio=0.1,
        num_classes=19,
    ...
    neck=dict(
        type='FPN',
        in_channels=[64, 128, 320, 512],#[64, 128, 320, 512],#[320, 790, 1430, 1280],,[,#
        out_channels=256,
        num_outs=5),
    # below are maskrcnn stuff
    simple_neck=dict(
        type='DecSimpleFeaturePyramid2',
    ...
    roi_head=dict(
        ...
        mask_head=dict(
            ...
            num_classes=num_instance_classes,
            loss_mask=dict(type='CrossEntropyLoss', use_mask=True, loss_weight=0))),
