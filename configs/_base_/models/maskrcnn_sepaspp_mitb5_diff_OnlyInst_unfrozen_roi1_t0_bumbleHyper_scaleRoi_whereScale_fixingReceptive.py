...
model = dict(
    type='MaskRCNNPanopticDiffUnfrozenT0ScaleRoiWhereScalefixRec',
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(type='CrossEntropyLoss', use_sigmoid=False, loss_weight=0),#maskrcnn_losses_weights),
