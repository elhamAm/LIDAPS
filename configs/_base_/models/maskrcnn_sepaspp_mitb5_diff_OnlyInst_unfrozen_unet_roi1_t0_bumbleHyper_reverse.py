...
model = dict(
    type='MaskRCNNPanopticDiffUnetUnfrozenT0Reverse',
    ...
    neck=dict(
        type='FPN',
        in_channels=[1280, 1280, 640, 320],#[1280,1300, 660, 320],#[1280, 1300, 660, 320],#,#[1280,1300, 660, 320],#[320, 660, 1300, 1280],#[64, 128, 320, 512],#,#,[,#
        out_channels=256,
        num_outs=5),
    rpn_head=dict(
        type='RPNHead',
