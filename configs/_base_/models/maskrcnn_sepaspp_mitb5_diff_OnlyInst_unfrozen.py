...
model = dict(
    type='MaskRCNNPanopticDiffUnfrozen',
    ...
    neck=dict(
        type='FPN',
        in_channels=[320, 660, 1300, 1280],#[1280,1300, 660, 320],#[320, 660, 1300, 1280],#[64, 128, 320, 512],#,#,[,#
        out_channels=256,
        num_outs=5),
    rpn_head=dict(
        type='RPNHead',
    ...
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                type='MaxIoUAssigner',
                pos_iou_thr=0.5,#0.7,#0.9, #0.7,
                neg_iou_thr=0.4,#0.3,#0.1,
