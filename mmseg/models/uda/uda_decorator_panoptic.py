...
from mmseg.models import BaseSegmentorPanoptic, build_segmentor
...
class UDADecoratorPanoptic(BaseSegmentorPanoptic):

    def __init__(self, **cfg):
        super(BaseSegmentorPanoptic, self).__init__()
    ...
    def simple_test(self, img, img_meta, rescale=True, **kwargs):
        ...
        # print('return self.get_model().simple_test(img, img_meta, rescale)')
