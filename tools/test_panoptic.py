...
$ PYTHONPATH="PATH_TO_FILL/apps/code/CVPR2022/daformer_panoptic:$PYTHONPATH" && export PYTHONPATH
'''
...
# base_path = f'PATH_TO_FILL/CVLHDD/apps/experiments/daformer_panoptic_experiments/euler-exp1004/{exp_name}'
# CONFIG_FILE = f'{base_path}/{exp_name}.json'
# CHECKPOINT_FILE = f'{base_path}/latest.pth'
# SHOW_DIR = "PATH_TO_FILL/CVLHDD/apps/experiments/daformer_panoptic_experiments/euler-exp1004/" \
