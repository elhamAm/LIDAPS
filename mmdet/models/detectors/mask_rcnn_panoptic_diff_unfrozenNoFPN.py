...
class MaskRCNNPanopticDiffUnfrozenNoFPN(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenNoFPN, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        #breakpoint()
        self.patt=10000
        self.folder='mask_rcnn_panoptic_diff_unfrozenNoFPN'
        import os
    ...
    def extract_feat(self, img):
        ...
        #breakpoint()
        out = Fun.interpolate(outs[0], [256, 256], mode='bilinear', align_corners=True)
        if self.with_neck:
            #breakpoint()
