...
class MaskRCNNPanopticDiffUnfrozenT0ScaleRoiWhereScale(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenT0ScaleRoiWhereScale, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
    ...
    def extract_feat(self, img):
        ...
        if(not self.initialBackBone):
            ...
            #outs = [outs[3],outs[2],outs[1],outs[0]]
            #breakpoint()
            #outs
    ...
    def forward_train(self,
        ...
        if gt_bboxes:
            ...
            if not set_loss_to_zero:
                ...
                #proposal_list[0].detach()
                #proposal_list[1].detach()
    ...
    def simple_test(self, img, img_meta, rescale=True, proposals=None):
        ...
        save_image(im.float()/600, 'PATH_TO_FILL/'+self.folder+'_test/'+name)  
        #print('number of cars is: ', num_cars)          
        #breakpoint()
