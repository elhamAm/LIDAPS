...
class MaskRCNNPanopticDevilInst4NoCheckSizeClipMeanPoolContrastiveWeight(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDevilInst4NoCheckSizeClipMeanPoolContrastiveWeight, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
