...
class MaskRCNNPanopticDiffUnfrozenT0ScaleRoi(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenT0ScaleRoi, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        if(not self.initialBackBone):
            ...
            self.folder='diff_roi_hyperbumble_t0_testHypers_RoiScale_rpn_changedSamples'
