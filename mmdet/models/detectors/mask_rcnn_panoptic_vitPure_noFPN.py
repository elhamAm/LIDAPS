...
class MaskRCNNPanopticVitPureNoFPN(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticVitPureNoFPN, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        print('FINISHED THIS')
        import os
        #self.folder='orig_instOnly_vit_noFPN'
    ...
    def extract_feat(self, img):
        ...
        if self.with_neck:
            ...
            x_neck=[]
            #breakpoint()
            x_neck.append(x_backbone[0])
            x_neck.append(x_backbone[1])
            x_neck.append(x_backbone[2])
            x_neck.append(x_backbone[3])
            x_neck.append(Fun.interpolate(x_backbone[3], [8,8], mode='bilinear', align_corners=True))
            #breakpoint()
            #breakpoint()
