...
class MaskRCNNPanopticDiffUnfrozenT0ScaleRoiBothWeightedNonDetached(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenT0ScaleRoiBothWeightedNonDetached, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
