...
class MaskRCNNPanopticDiffUnetUnfrozenT0Reverse(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnetUnfrozenT0Reverse, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        if(not self.initialBackBone):
            ...
            self.folder='unet_roi_hyperbumble_t0_testHypers_noAttn_decay_test_same'
