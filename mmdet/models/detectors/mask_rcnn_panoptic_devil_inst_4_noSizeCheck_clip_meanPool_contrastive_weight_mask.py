...
class MaskRCNNPanopticDevilInst4NoCheckSizeClipMeanPoolContrastiveWeightMask(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDevilInst4NoCheckSizeClipMeanPoolContrastiveWeightMask, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
    ...
    def forward_train(self,
        ...
        if gt_bboxes:
            ...
            if not set_loss_to_zero:
                ...
                losses['roi.loss_clip_inst'] = loss_contrast*0.1#.float()#*100.
