# --------------------------------------------------------------------------------
# Copyright (c) 2024 ETH Zurich, Elham Amin Mansour, on the basis of the work of Suman Saha, Lukas Hoyer 2022-2023.
# 
# --------------------------------------------------------------------------------
...
class MaskRCNNPanopticDevilPS(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDevilPS, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
    ...
    def simple_test(self, img, img_meta, rescale=True, proposals=None):
        ...
        #breakpoint()
        #np.save('example.npy', np.asarray(inst_pred, dtype=object))
        if(show):
