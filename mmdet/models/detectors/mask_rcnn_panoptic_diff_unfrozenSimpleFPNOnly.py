...
class MaskRCNNPanopticDiffUnfrozenSimpleFPNOnly(TwoStageDetectorOther):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenSimpleFPNOnly, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
        ...
        #breakpoint()
        self.patt=100000
        self.folder='mask_rcnn_panoptic_diff_unfrozenSimpleFPNOnly'
        import os
    ...
    def extract_feat(self, img):
        ...
        if self.with_neck:
            #breakpoint()
            x_neck=self.simple_neck(x_backbone)
            #breakpoint()
