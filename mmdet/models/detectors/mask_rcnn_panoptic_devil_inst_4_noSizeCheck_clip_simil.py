...
class MaskRCNNPanopticDevilInst4NoCheckSizeClipSimil(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDevilInst4NoCheckSizeClipSimil, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        self.pool = torch.nn.MaxPool2d(7, stride=2)
