...
class MaskRCNNPanopticDiffUnfrozenVer2(TwoStageDetectorOther):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenVer2, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
        ...
        #breakpoint()
        self.patt=1000
        self.folder='mask_rcnn_panoptic_diff_unfrozen'
        import os
    ...
    def extract_feat(self, img):
        ...
        if(not self.initialBackBone):
            ...
            #breakpoint()
            t = torch.ones((img.shape[0],), device=img.device).long()#changed this to 0
            #self.backbone.eval()
