...
class MaskRCNNPanopticDevilInst4NoCheckSizeClipMeanPoolContrastiveMask(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDevilInst4NoCheckSizeClipMeanPoolContrastiveMask, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
