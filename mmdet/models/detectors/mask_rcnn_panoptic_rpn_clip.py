...
class MaskRCNNPanopticRPNClip(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticRPNClip, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        if gt_bboxes:
            ...
            if not set_loss_to_zero:
                ...
                if self.with_rpn:
                    ...
                    #breakpoint()
                    rpn_losses, proposal_list = self.rpn_head.forward_train(    img,
                                                                                x_n,
                                                                                img_metas,
                                                                                gt_bboxes,
                                                                                gt_labels=None,
