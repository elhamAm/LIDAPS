...
from mmdet.models.detectors.clipDense import CLIPVisionTransformer
#breakpoint()
@DETECTORS.register_module()
class MaskRCNNPanopticClipVitVisionSpatial(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticClipVitVisionSpatial, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        if(denseClip):
            ...
            self.clip=build_model(state_dict).visual.float().to('cuda')
