...
class MaskRCNNPanopticDiffUnfrozenT0(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenT0, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        if(not self.initialBackBone):
            ...
            self.folder='diffusion_roi_hyperbumble_t0_testHypers'
    ...
    def extract_feat(self, img):
        ...
        if self.with_neck:
            x_neck = self.neck(outs)#outs_orig)
        #breakpoint()
