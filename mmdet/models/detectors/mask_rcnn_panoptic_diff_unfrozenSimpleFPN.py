...
class MaskRCNNPanopticDiffUnfrozenSimpleFPN(TwoStageDetectorOther):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenSimpleFPN, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
        ...
        #breakpoint()
        self.patt=10000
        self.folder='mask_rcnn_panoptic_diff_unfrozenSimpleFPN'
        import os
