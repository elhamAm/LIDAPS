    ...
    def forward_train(self,
        ...
        if gt_bboxes:
            ...
            if not set_loss_to_zero:
                ...
                #if(self.count%50 == 0):
                #    save_image((img[0]+1.)/2., 'PATH_TO_FILL/diffusion3/'+name)
                #breakpoint()
                ...
                from torchvision.utils import save_image
                #if(self.count%50 == 0):
                #    save_image((rpn_img[0]+1.)/2., 'PATH_TO_FILL/diffusion3/'+name)

                name=str(self.count)+'_gt_bb_train.png'
                #if(self.count%50 == 0):
                #    save_image((gt_img[0]+1.)/2., 'PATH_TO_FILL/diffusion3/'+name)
                self.count+=1
