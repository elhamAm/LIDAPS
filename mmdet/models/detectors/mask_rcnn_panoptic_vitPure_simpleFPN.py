...
class MaskRCNNPanopticVitPureSimpleFPN(TwoStageDetectorOther):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticVitPureSimpleFPN, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
        ...
        #     if(self.train_cfg['name']=='conv'):#'diff_roi_hyperbumble_t0_testHypers_RoiScale_where_scale56_bothWeighted0'
        #         #breakpoint()
        #         self.folder='orig_instOnly_vit_simpleFPN'
        #     else:
        #         self.folder='orig_instOnly_vit_simpleDeconvFPN'
        # else:
        #     if(self.test_cfg['name']=='conv'):#'diff_roi_hyperbumble_t0_testHypers_RoiScale_where_scale56_bothWeighted0'
        #         self.folder='orig_instOnly_vit_simpleFPN'
        #     else:
        #         self.folder='orig_instOnly_vit_simpleDeconvFPN'
    ...
    def extract_feat(self, img):
        ...
        if self.with_neck:
            x_simple_neck = self.simple_neck(x_backbone)
            x_neck = self.neck(x_simple_neck)
            #(Pdb) x_neck[0].shape
            #torch.Size([2, 256, 128, 128])
            #(Pdb) x_neck[1].shape
            #torch.Size([2, 256, 64, 64])
