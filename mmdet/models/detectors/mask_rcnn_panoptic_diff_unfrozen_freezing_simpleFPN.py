...
class MaskRCNNPanopticDiffUnfrozenFreezingSimpleNeck(TwoStageDetectorOther):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnfrozenFreezingSimpleNeck, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
        ...
        #breakpoint()
        self.patt=100000
        self.folder='mask_rcnn_panoptic_diff_unfrozenFreezing'
        import os
    ...
    def extract_feat(self, img):
        ...
        if(not self.initialBackBone):
            ...
            #outs=[outs[0].detach(), outs[1].detach(), outs[2].detach(), outs[3].detach()]
        ...
        if self.with_neck:
            ...
            #breakpoint()
            x_neck = self.neck(x_simple_neck)#outs_orig)
        #breakpoint()
