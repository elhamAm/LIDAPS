...
class MaskRCNNPanopticDiffUnetT0(TwoStageDetector):
    ...
    def __init__(self,
                 ...
                 auxiliary_head=None):
        super(MaskRCNNPanopticDiffUnetT0, self).__init__(
                                                backbone=backbone,
                                                neck=neck,
                                                rpn_head=rpn_head,
                                                roi_head=roi_head,
        ...
        if(not self.initialBackBone):
            ...
            self.folder='frozen_unet_roi_hyperbumble_t0_testHypers'
    ...
    def extract_feat(self, img):
        ...
        if(not self.initialBackBone):
            ...
            with torch.no_grad():
                ...
                outs_orig=[outs[3],outs[2],outs[1],outs[0]]
                #breakpoint()
            x_backbone = outs
        else:
