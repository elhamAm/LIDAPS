...
@UDA.register_module()
class DACSTEACHER(UDADecorator):

    def __init__(self, **cfg):
        super(DACSTEACHER, self).__init__(**cfg)
        self.local_iter = 0
    ...
    def simple_test(self, img, img_meta, rescale=True, proposals=None):
        #breakpoint()
        return self.get_ema_model().simple_test(img, img_meta, rescale=rescale, proposals=proposals)
